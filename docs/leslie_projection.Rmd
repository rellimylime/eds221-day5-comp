...
# Create a time sequence from 0 to 8
time_yr <- seq(from = 0, to = 8, by = 1)

# Create an empty matrix with number of columns/rows corresponding to initial population/time in years
proj_year <- matrix(ncol = length(fish_year0), nrow = length(time_yr))

# assigns fish_year0 as the first row of proj_year 
proj_year[1, ] <- fish_year0

# starts in the second row and dots the fish_leslie vecotr with the previous proj_year row
